  ...
  render() {
    return (
      <View style={styles.container}>
        <View style={{width: 420, height: 650, paddingTop: 0}} ><Image source={require('./page5_img/User_Page Bg_2.png')} style={{width: 420, height: 260, paddingTop: 0 }} />
        <ScrollView style={{width: 400, height: 720, paddingTop: 20, paddingLeft: 20}} ><Image source={require('./page5_img/Context.png')} style={{width: 420, height: 700}} /></ScrollView>
        </View>
      </View>
    );
  }
...
class User_Page_2 extends Component {
  ...
  render() {
    return (
      <View style={styles.container}>
        <ImageBackground source={require('./page5_img/User_Page Bg_4.png')} style={{width: 420, height: 650, paddingTop: 0 }}>
